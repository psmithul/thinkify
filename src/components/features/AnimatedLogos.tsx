...
const AnimatedLogos = () => {
  ...
  return (
    <div className="relative w-full">
      {/* Prominent section header - Moved outside and above the grid */}
      <motion.div 
      ...
      >
        <motion.h2 
          ...
          className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-gray-900 via-indigo-600 via-rose-600 to-orange-600 bg-[length:300%_100%] bg-clip-text text-transparent"
        >
      ...
      <div 
        ref={containerRef}
        className="relative w-full h-full overflow-hidden bg-gradient-to-br from-white/80 via-indigo-50/30 to-orange-50/40 rounded-3xl border-2 border-rose-200/30 backdrop-blur-sm shadow-xl"
      ...
      >
        ...
        <div className="absolute inset-0 opacity-30 pointer-events-none">
          <div className="absolute inset-0" style={{
            backgroundImage: `radial-gradient(circle at 25% 25%, rgba(99, 102, 241, 0.08) 0%, transparent 50%),
                             ...
                             radial-gradient(circle at 50% 50%, rgba(251, 146, 60, 0.06) 0%, transparent 70%)`
          }}></div>
          ...
          <svg className="absolute inset-0 w-full h-full" style={{ zIndex: 1 }}>
            <defs>
              ...
              <pattern id="dots" width="60" height="60" patternUnits="userSpaceOnUse">
                <circle cx="30" cy="30" r="1" fill="rgba(244, 63, 94, 0.15)"/>
              </pattern>
            </defs>
        ...
        <motion.div
          className="absolute w-3 h-3 bg-gradient-to-br from-indigo-500/30 to-orange-500/30 rounded-full shadow-lg"
          style={{
            left: '50%',
            top: '50%',
