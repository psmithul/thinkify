...
import { createEmailTemplate, makePhoneCall, openWhatsApp } from "@/lib/utils";
...
const CTABanner = () => {
  ...
  const handleEmailClick = () => {
    window.location.href = createEmailTemplate("Partnership Inquiry - CTA Banner", "CTA Banner Section");
  };
    ...
    <section className="py-32 relative overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-10 right-20 w-20 h-20 bg-gradient-to-br from-indigo-200 to-purple-200 rounded-full opacity-20"
        />
        <motion.div
          animate={{ 
            y: [0, 25, 0],
          ...
          className="absolute bottom-20 left-10 w-16 h-16 bg-gradient-to-br from-purple-200 to-indigo-200 rounded-full opacity-15"
        />
      </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                <a 
                  href={createEmailTemplate("Partnership Inquiry - Email Link", "CTA Banner Email")} 
