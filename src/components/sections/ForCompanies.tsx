...
const ForCompanies = () => {
  ...
  return (
    <section id="for-companies" className="py-32 relative overflow-hidden">
      {/* Background effects */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#E3FDFD]/60 to-[#A6E3E9]/60" />
      ...
      >
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-[#0C6980]">For Startups</h2>
            <p className="text-lg text-[#0C6980]/90 mb-6">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#71C9CE] mr-2 mt-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="9 11 12 14 22 4"></polyline>
                  <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path>
                </svg>
                <span className="text-[#0C6980]/90">70% faster engineer onboarding for early-stage startups</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#71C9CE] mr-2 mt-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="9 11 12 14 22 4"></polyline>
                ...
                <span className="text-[#0C6980]/90">Save 100+ interviewing hours per hire</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#71C9CE] mr-2 mt-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="9 11 12 14 22 4"></polyline>
                ...
                <span className="text-[#0C6980]/90">Engineers who contribute from day one, technically vetted by veterans</span>
              </li>
            </ul>
          </motion.div>
              ...
              <motion.div key={index} variants={item}>
                <Card className="glass-card h-full border-0">
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl text-[#0C6980]">{feature.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-[#0C6980]/80">{feature.description}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
