  ...
  const footerLinks = [
    {
      title: "What We Do",
      links: [
        { name: "Recruitment-as-a-Service", href: "https://connect.thinkify.io" },
        { name: "Product Engineering Pods", href: "https://connect.thinkify.io" },
        { name: "Fractional CTOs", href: "https://connect.thinkify.io" },
        { name: "Tech Strategy", href: "https://connect.thinkify.io" },
      ],
    },
    {
      title: "Our Clients",
      links: [
        { name: "Startups", href: "https://connect.thinkify.io" },
        { name: "Series A & Beyond", href: "https://connect.thinkify.io" },
        { name: "VC-Backed Companies", href: "https://connect.thinkify.io" },
        { name: "Case Studies", href: "https://connect.thinkify.io" },
      ],
    },
    {
      title: "Company",
      links: [
        { name: "About us", href: "https://connect.thinkify.io" },
        { name: "Team", href: "https://connect.thinkify.io" },
        { name: "Blog", href: "https://connect.thinkify.io" },
        { name: "Careers", href: "https://connect.thinkify.io" },
      ],
    },
  ];
