...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="border-t border-rose-100 bg-gradient-to-br from-indigo-50/30 via-white to-orange-50/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-10 left-10 w-32 h-32 bg-gradient-to-br from-indigo-200 to-rose-200 rounded-full opacity-20"
        />
        <motion.div
          animate={{
            y: [0, 20, 0],
          ...
          className="absolute bottom-20 right-20 w-24 h-24 bg-gradient-to-br from-rose-200 to-orange-200 rounded-full opacity-25"
        />
        <motion.div
          animate={{
            x: [0, 15, 0],
          ...
          className="absolute top-1/3 right-1/4 w-16 h-16 bg-gradient-to-br from-orange-300 to-indigo-300 rounded-full opacity-20"
        />
      </div>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
          ...
          >
            ...
            >
              ...
              <div className="space-y-3">
                ...
                >
                  <motion.div 
                    className="h-10 w-10 mr-3 bg-rose-100 rounded-full flex items-center justify-center text-rose-600"
                    whileHover={{ 
                      scale: 1.1,
                  ...
                  <div>
                    <div className="font-medium group-hover:text-rose-600 transition-colors">Email Us</div>
                ...
                >
                  <div 
                    className="h-10 w-10 mr-3 bg-gradient-to-br from-indigo-100 to-orange-100 rounded-full flex items-center justify-center text-indigo-600"
                  >
                  ...
                  <div>
                    <div className="font-medium group-hover:text-indigo-600 transition-colors">Chat on WhatsApp</div>
              ...
              <ul className="space-y-3">
                {column.links.map((link, linkIdx) => (
                  ...
                  >
                    ...
                    >
                      <motion.span
                        className="mr-2 opacity-0 group-hover:opacity-100 text-rose-600"
                        initial={{ x: -10 }}
                        whileHover={{ x: 0 }}
                        transition={{ duration: 0.2 }}
                      >
        ...
        {/* Bottom footer */}
        <motion.div 
          className="pt-8 border-t border-rose-100"
          initial={{ opacity: 0 }}
            ...
            >
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="w-10 h-10 bg-gradient-to-r from-indigo-100 to-orange-100 hover:from-indigo-200 hover:to-orange-200 rounded-full flex items-center justify-center text-gray-600 hover:text-rose-600 transition-all duration-300 group shadow-sm hover:shadow-md"
