...
import { openWhatsApp, copyToClipboard, formatPhoneNumber, trackLinkedInConversion } from "@/lib/utils";
...
const FloatingContact = () => {
  ...
  const handleCopyContact = async () => {
    const contactInfo = `Thinkify Contact:
📧 Email: hello@thinkify.io
📞 Phone: +91 99024 17369
🌐 Website: thinkify.io

Quick Connect via WhatsApp for instant responses!`;
  ...
  const contactOptions = [
    ...
    },
    {
      ...
      action: () => {
        trackLinkedInConversion();
        openWhatsApp("Hi! I'm interested in Thinkify's services.");
      },
