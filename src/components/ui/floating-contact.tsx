...
import { createEmailTemplate, makePhoneCall, openWhatsApp, copyToClipboard, formatPhoneNumber } from "@/lib/utils";
  ...
  const contactOptions = [
    {
      ...
      action: () => window.location.href = createEmailTemplate("Quick Contact - Floating Button", "Floating Contact Widget"),
    ...
    },
    {
      ...
      tooltip: formatPhoneNumber("9902417369")
    },
    {
      label: "WhatsApp",
      icon: (
